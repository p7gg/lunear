...
>(({ className, children, checked, indicatorPosition, ...props }, ref) => (
	...
	>
		<span
			className={`absolute ${indicatorPosition === "right" ? "right-2" : "left-2"} flex h-3.5 w-3.5 items-center justify-center`}
		>
...
>(({ className, children, indicatorPosition, ...props }, ref) => (
